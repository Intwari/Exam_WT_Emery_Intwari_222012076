...
<li><a href="home.php" class="return-home-btn" style="text-decoration: none;">Back Home</a></li>
    <section id="practice">
        <h2>Practice Deutsch Vocabulary</h2>
    ...
    <script>
     const exercises = [
    {
        image: 'image/haus.jpg',
        options: ['Auto', 'Kuh', 'Pferd', 'Haus'],
        correct: 'Haus'
    },
    {
        image: 'image/sonne.jpg',
        options: ['Mond', 'Stern', 'Sonne', 'Wolke'],
        correct: 'Sonne'
    },
    {
        image: 'image/stuhl.jpg',
        options: ['Tisch', 'Bett', 'Stuhl', 'Sofa'],
        correct: 'Stuhl'
    },
    {
        image: 'image/Kaffee.jpg',
        options: ['Heft', 'Kaffee', 'Zeitung', 'Karte'],
        correct: 'Kaffee'
    },
];
