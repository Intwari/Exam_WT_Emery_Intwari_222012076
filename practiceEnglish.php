...
<body>
    <!-- Back Home Button -->
    <a href="home.php" class="return-home-btn">Back Home</a>

    <section id="practice">
        <h2>Practice English Vocabulary</h2>
        ...
        const exercises = [
            {
                ...
                options: ['Car', 'Cow', 'Horse', 'House'],
                correct: 'House'
            },
            {
                image: 'image/car.jpg',
                options: ['Cat', 'Cable', 'Car', 'Bike'],
                correct: 'Car'
            },
            {
                image: 'image/dog.jpg',
                options: ['Kid', 'Dog', 'Banana', 'Duck'],
                correct: 'Dog'
            },
            {
                image: 'image/bikee.jpg',
                options: ['Animal', 'Bread', 'Bike', 'Car'],
                correct: 'Bike'
            },
