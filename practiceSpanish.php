...
<li><a href="home.php" class="return-home-btn" style="text-decoration: none;">Back Home</a></li>
    <section id="practice">
        <h2>Practice Spanish Vocabulary</h2>
       ...
       const exercises = [
    {
        ...
        options: ['Silla', 'Mesa', 'Cama', 'Armario'],
        correct: 'Mesa' // Table
    },
    {
        image: 'image/pato.jpg',
        options: ['Perro', 'Gato', 'Pato', 'Ave'],
        correct: 'Pato' // Duck
    },
    {
    ...
    {
        image: 'image/telefono.jpg',
        options: ['Libro', 'Cuchillo', 'Cepillo', 'Teléfono'],
        correct: 'Teléfono' // Phone
    },
    {
        image: 'image/cuchara.jpg',
        options: ['Tenedor', 'Cuchara', 'Cuchillo', 'Plato'],
        correct: 'Cuchara' // Spoon
    },
];
