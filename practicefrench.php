...
<li><a href="home.php" class="return-home-btn" style="text-decoration: none;">Back Home</a></li>
    <section id="practice">
        <h2>Practice French Vocabulary</h2>
    ...
    const exercises = [
    {
        ...
        options: ['Chien', 'Chat', 'Cheval', 'Lapin'],
        correct: 'Chat'
    },
    {
        image: 'image/poisson.jpg',
        options: ['Oiseau', 'Poisson', 'Chien', 'Chat'],
        correct: 'Poisson'
    },
    {
        image: 'image/avion.jpg',
        options: ['Voiture', 'Bateau', 'Avion', 'Vélo'],
        correct: 'Avion'
    },
    {
        image: 'image/arbre.jpg',
        options: ['Fleur', 'Arbre', 'Herbe', 'Feuille'],
        correct: 'Arbre'
    },
    {
        image: 'image/livre.jpg',
        options: ['Stylo', 'Papier', 'Livre', 'Ordinateur'],
        correct: 'Livre'
    },
];
